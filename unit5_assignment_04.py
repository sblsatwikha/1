...
def test_left_binary_search_student():
    assert 2==left_binary_search([1,2,3,3,4,5],3)
    assert -1==left_binary_search([1,2,3],7)
    assert 0==left_binary_search([1, 1, 1, 1, 1, 1, 1, 1],1)
    assert 2==left_binary_search([1,2,3,3,3,4,5],3)
    assert 1==left_binary_search([1,2,2,3,3,4,5],2)
