...
def test_make_assert_true_2():
    assert 3**40> 2**30, "Fill in value greater than 2**30"
...
-in the form 'assert <exp>',if exp is true then it executes the remaining code or if it is false it gets an assertion error
-in the form 'assert <exp> <message>'if exp is true then it executes the code or it gets an assertion code displaying the message
-in the form assert with conditions,if these 2 expressions satisfy the conditions it executes otherwise displays assertion error
"""